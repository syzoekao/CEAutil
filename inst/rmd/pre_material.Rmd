...
```
  ...
  * For example, I want to run the R script `hello.R` in the `Rscript/` folder in your working directory. 
...
1. How to convert decision tree from Amua to R code and calculate outcomes.
2. How to vary parameter values and obtain outcomes for different parameter values.
