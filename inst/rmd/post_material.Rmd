...
2. This would evoke the Shiny app interface. 

![](Figure/Shiny1.png)

3. On this interface, you have to fill out the name of the parameters, the distribution, and the parameters of the distribution in the input area on the left-hand side. 
4. Pay attention to the description of different distribution that you specified. You could only fill out one set of parameters for some distributions (e.g., beta, gamma, log-normal, etc.). 
...
5. After you fill out the required values of a parameter on the left-hand side, the table on the right-hand side will display the values in a table. 
6. Once you finish all the parameter inputs, click the button `generate code`. The App generates the `gen_psa_samp` code for you. 
7. [CAUTION] This Shiny app is still under developmenet. 
